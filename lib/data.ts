...
export const projectsData = [
  {
    title: "Wild Oasis",
    description:
      "Wild Oasis is a comprehensive platform designed to facilitate cabin bookings for users seeking a tranquil getaway.",
    tags: ["React", "ReactQuery", "Next","Vite","Jenkins","Spring Boot Java", "Mysql"],
